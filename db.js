...
const db = new Database(path.join(__dirname, 'data', 'mkfinance.db'));
...
if (vehicleCount === 0) {
  ...
  const samples = [
    ...
    { category: 'Car', brand: 'KIA', model: 'Seltos', year: '2024', price: '₹10.90 L', fuel_type: 'Petrol | iMT', image_url: '', icon: '🚙', emi: 'EMI ₹19,100/mo', tags: 'NEW,LOAN READY,INSURE', description: '' },
    { category: 'Car', brand: 'HONDA', model: 'City', year: '2024', price: '₹11.57 L', fuel_type: 'Petrol/Hybrid', image_url: '', icon: '🚗', emi: 'EMI ₹20,200/mo', tags: 'NEW,LOAN READY,INSURE', description: '' },
    { category: 'Car', brand: 'VOLKSWAGEN', model: 'Virtus', year: '2024', price: '₹11.56 L', fuel_type: 'Petrol | DSG', image_url: '', icon: '🏎️', emi: 'EMI ₹20,200/mo', tags: 'NEW,LOAN READY,INSURE', description: '' }
  ];
